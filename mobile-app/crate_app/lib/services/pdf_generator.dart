  ...
  Future<bool> generateAndSavePdf({
    ...
    try {
      ...
      String? filePath = await FilePicker.platform.saveFile(
        ...
        fileName: 'invoice_${now.day.toString().padLeft(2, '0')}_${now.month.toString().padLeft(2, '0')}_${now.year}-${now.hour.toString().padLeft(2, '0')}_${now.minute.toString().padLeft(2, '0')}.pdf',
